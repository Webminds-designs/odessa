...
const persons = [
    { src: '/images/person1.png', right: "right-[72px] sm:right-[84px] md:right-[96px]" },
    { src: '/images/person2.png', right: "right-[48px] sm:right-[56px] md:right-[64px]" },
    { src: '/images/person3.png', right: "right-[24px] sm:right-[28px] md:right-[32px]" },
    { src: '/images/person4.png', right: "right-0" },
]

const Highlight = () => {
    return (
        <div className='flex flex-col lg:flex-row gap-4 lg:gap-7 w-full px-4 sm:px-6 md:px-8 lg:px-10 py-5 sm:py-7 bg-primary'>
            {/* First Card */}
            ...
            <div className='bg-brown px-4 sm:px-6 md:px-10 py-5 sm:py-6 md:py-8 rounded-xl flex flex-col gap-4 sm:gap-6 md:gap-10 w-full lg:w-[40%] xl:w-1/3'>
                ...
                <div className='flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0'>
                    <p className='font-vasion text-2xl sm:text-3xl md:text-4xl lg:text-5xl'>4.8K</p>
